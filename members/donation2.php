    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_student=mysqli_query($conn,"select * from donation where na='$session_id'");
...
<!-----------------------------------Content------------------------------------>
<?php
		$student_query = mysqli_query($conn,"SELECT *FROm members  LEFT OUTER JOIN donation ON members.id = donation.na WHERE donation.na ='$session_id' ")or die(mysqli_error());
