	 ...
	 <div class="span3" id="sidebar">
                  ...
                  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
						 ...
						 <li>						
                            ...
                            <li class="">
                            <a href="donation.php"><i class="icon-chevron-right"></i><i class="icon-user"></i> My Offerings</a>
                            </li>
					    ...
					    <li>						
                            ...
                            <li class="">
                            <a href="donation.php"><i class="icon-chevron-right"></i><i class="icon-money"></i> Donate Now</a>
                            </li>
						    <li class="">
