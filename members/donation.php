    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php	
	             $count_user=mysqli_query($conn,"select * from donation Where na= '$session_id'");
                            ...
                            <div class="block-content collapse in">
								...
								<form action="delete_users.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$user_query = mysqli_query($conn,"select * from members INNER JOIN donation ON members.id=donation.na where na='$session_id'")or die(mysqli_error());
