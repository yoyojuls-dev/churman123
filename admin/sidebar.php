...
<link rel="shortcut icon" href="images/logo.png" />
	 <div class="span3" id="sidebar">
            ...
            <li>						
                            ...
                            <li class="">
                            <a href="scheduledate.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Visitors Attendance Report</a>
                            </li>
						   		<li class="">
                            <a href="sschoolDetail.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Donations Report</a>
                            </li>		
						    
							 <li>
                            <a href="add_apply.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Tithes Report
							</a>
                            </li>
							<li>
                            <a href="add_sundaysch.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Offerings Report
							</a>
                            </li>
              <li>
                            <a href="add_sundaysch.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Givings Report
							</a>
                            </li>
                            </ul>
                            </li>
                        ...
                        <li>						
                            ...
                            <li class="">
                            <a href="scheduledate.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Baptismal Certificate</a>
                            </li>
						   		<li class="">
                            <a href="sschoolDetail.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Marriage Certificate</a>
                            </li>		
						    
							 <li>
                            <a href="add_apply.php"><i class="icon-chevron-right"></i><i class="icon-file"></i> Dedication Certificate
							</a>
                            </li>
